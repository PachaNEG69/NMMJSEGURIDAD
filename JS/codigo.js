...
/* CODIGO PARA MODIFICAR EL BODY, EL TEXTO Y LAS IMAGENES */
ajustes.onclick = function() {
    ajustes.classList.toggle('active');
};
...
$('.reducirImg').click(function() {
    $('img').css('width', '100');
    $('img').css('height', '100');
});

$('.restablecerImg').click(function() {
    $('img').css('width', '200');
    $('img').css('height', '200');
});

$('.agrandarImg').click(function() {
    $('img').css('width', '300');
    $('img').css('height', '300');
});
/* CODIGO PARA MODIFICAR EL BODY, EL TEXTO Y LAS IMAGENES */
