...
cambiosBtn.onclick = function() {
    cambiosBtn.classList.toggle('active');
};

let dia = document.querySelector('.dia');

cambiosBtn.addEventListener('click', () => {
    dia.classList.toggle('dia_visible');
});

let noche = document.querySelector('.noche');

cambiosBtn.addEventListener('click', () => {
    noche.classList.toggle('noche_visible');
});
...
$('.dia').click(function() {
    ...
    $('img').css('opacity', '1');
    $('.dia').css('background', 'red');
    $('.noche').css('background', '#808080');
});

$('.noche').click(function() {
    $('body').css('background', '#000');
    $('main').css('background', '#f4500f');
    $('main').css('opacity', '0.8');
    $('.lista').css('color', '#000');
    $('.menu').css('opacity', '0.9');
    $('img').css('opacity', '0.6');
    $('.noche').css('background', 'red');
    $('.dia').css('background', '#808080');
});
