/* CODIGO PARA ACTIVAR LA PRE-CARGA */
...
$('.dia').css('background', '#ff0000')

$('.dia').click(function() {
    $('.dia').css('background', '#ff0000');
    $('.noche').css('background', '#0000ff');
    $('body').css('background', '#f4500f');
    $('main').css('background', '#2f4f4f');
    $('.lista').css('color', '#fff');
    $('img').css('opacity', '1');
})
...
noche.onclick = function() {
    noche.classList.toggle('active');
};

$('.noche').click(function() {
    $('.noche').css('background', '#ff0000');
    $('.dia').css('background', '#0000ff');
    $('body').css('background', '#000');
    $('main').css('background', '#221022');
    $('.lista').css('color', '#000');
    $('img').css('opacity', '0.7');
})
/* ANIMACION PARA EL MENU QUE LLAMA LOS ICONOS PARA CAMBIAR EL MODO DE DIA O DE NOCHE */
